...
public enum Message {
	NO_METHOD("Unable to set deferred breakpoint %s.%s : No method %s in %s"), DEFER_BREAKPOINT(
			"Deferring breakpoint %s.%s.\nIt will be set after the class is loaded."), DEFER_BREAKPOINT_LOC(
			"Deferring breakpoint %s:%d.\nIt will be set after the class is loaded."), HIT_BREAKPOINT(
			...
			"The application exited."), UNKNOWN("Name unknown: %s"), VAR(
			"%s %s = %s"), INVALID_CMD("Command not valid: '%s'");
